...
export var htmlLanguageService = registerHTMLLanguageService(htmlLanguageId, htmlOptionsDefault, getConfigurationDefault(htmlLanguageId));
export var htmlDefaults = htmlLanguageService.defaults;
export var handlebarLanguageService = registerHTMLLanguageService(handlebarsLanguageId, handlebarOptionsDefault, getConfigurationDefault(handlebarsLanguageId));
export var handlebarDefaults = handlebarLanguageService.defaults;
export var razorLanguageService = registerHTMLLanguageService(razorLanguageId, razorOptionsDefault, getConfigurationDefault(razorLanguageId));
